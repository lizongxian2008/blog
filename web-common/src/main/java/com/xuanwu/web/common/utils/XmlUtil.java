...
public class XmlUtil {
	...
	private static final String VALUE_INT_OPEN = "<int>";
	private static final String VALUE_INT_CLOSE = "</int>";
	...
	@SuppressWarnings("unchecked")
	public static String toRawXml(Object obj) {
	...
	private static void addEntry(StringBuilder sb, String key, Object value) {
		if (key == null || value == null) {
			throw new IllegalArgumentException("key or value is null");
		}
		sb.append(ENTRY_OPEN);
		...
		if (value instanceof Integer) {
			sb.append(VALUE_INT_OPEN);
		} else {
			sb.append(VALUE_OPEN);
		}
		escapeElementEntities(sb, value.toString());
		if (value instanceof Integer) {
			sb.append(VALUE_INT_CLOSE);
		} else {
			sb.append(VALUE_CLOSE);
		}
		sb.append(ENTRY_CLOSE);
